...
func main() {
	...
	privKey, err := w_dpop.GenerateECDSAKey()
	if err != nil {
	...
	jkt, err := w_dpop.JWKThumbprint(jwk)
	if err != nil {
	...
	proof, err := w_dpop.CreateProof(privKey, w_dpop.ProofOptions{
		Method:      method,
		URI:         uri,
	...
	result, err := w_dpop.VerifyProof(opts)
	if err != nil {
